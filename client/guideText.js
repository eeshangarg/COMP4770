...
navGuideCanvas.fillText("W: Jump", 5, 50);
navGuideCanvas.fillText("A: Left      |    D: Right", 5, 75);
navGuideCanvas.fillText("Attack: Space", 5, 100);
navGuideCanvas.fillText("Q: Red potion ", 5, 125);
navGuideCanvas.fillText("R: Blue Potion", 5, 150);
navGuideCanvas.fillText("E: Fireball", 5, 175);
navGuideCanvas.fillText("ESC: Return", 5, 200);
