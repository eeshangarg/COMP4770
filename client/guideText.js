...
navGuideCanvas.fillText("Gameplay Keys:", 5, 25);
navGuideCanvas.font = "16px sans-serif";
navGuideCanvas.fillText("W: Jump | A: Left | D: Right", 5, 50);
navGuideCanvas.fillText("Attack: Space", 5, 75);
navGuideCanvas.fillText("Q: Red potion ", 5, 100);
navGuideCanvas.fillText("R: Blue Potion", 5, 125);
navGuideCanvas.fillText("E: Fireball", 5, 150);
navGuideCanvas.fillText("ESC: Return", 5, 175);
navGuideCanvas.fillText("1,2,3: Play as NPCs (cheat)", 5, 200);
